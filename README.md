...
- Build and upload VyOS release assets (stable + beta/manual): `.github/workflows/publish-release-assets.yml`
- Manual build artifact workflow: `.github/workflows/build-vyos-cloudinit.yml`
